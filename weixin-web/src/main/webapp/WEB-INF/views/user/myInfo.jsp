    ...
    <div class="row">
      <div class="col-md-3">
        ...
        <div class="thumbnail center-block">
          <img src="${ctxStatic}/img/logo.jpg" alt="头像" height="200px" width="200px">
        </div>
      </div>
      <div class="col-md-9">
        ...
        <div id="myTabContent" class="tab-content">
          <div role="tabpanel" class="tab-pane fade active in" id="myInfo" aria-labelledby="myInfo-tab">
            ...
            <form class="form-horizontal">
              ...
              <div class="form-group">
                <strong class="readonly">本次登录：</strong>
                <em>IP：</em><span> 0:0:0:0:0:0:0:1</span>&nbsp;&nbsp;&nbsp;&nbsp;
                <em>时间：</em><time>2016年3月28日 星期一 15:20:39</time>
              </div>
              <div class="form-group">
